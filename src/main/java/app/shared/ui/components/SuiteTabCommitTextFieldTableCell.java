 ...
 */
public class SuiteTabCommitTextFieldTableCell<S, T> extends TextFieldTableCell<S, T> {
    ...
    public SuiteTabCommitTextFieldTableCell(StringConverter<T> converter) {
        super(converter);
    }
    ...
    public static <S, T> Callback<TableColumn<S, T>, TableCell<S, T>> forTableColumn(StringConverter<T> converter) {
        return column -> new SuiteTabCommitTextFieldTableCell<>(converter);
    }
