 ...
 */
public class TmdbTvShowRepository {

    private static final Logger log = Logger.getLogger(TmdbTvShowRepository.class.getName());
     ...
     */
    public static class TvShowComparisonData {
