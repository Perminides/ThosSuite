 ...
 */
public record ShapeMap(String id, String deckId, String regionName, String capitalName, Set<String> altRegionNames,
		Set<String> altCapitalNames, String type, Node shape, boolean isShapeMap) {
	
	public ShapeMap(Node shape, String id, String deckId, String regionName, String capital, String altRegionNames, String altCapitalNames,
