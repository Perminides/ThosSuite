...
import app.movie.model.json.EpisodeRatingJSON;
...
import app.movie.repository.SeasonRepository;
...
public class SeriesImporter {
    ...
    private void processEpisodesWithoutOverview() {
        List<EpisodeForApi> episodes = episodeRepo.getEpisodesWithoutOverview();
        for (var ep : episodes) {
            try {
