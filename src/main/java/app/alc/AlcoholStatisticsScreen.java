...
import app.alc.model.AlcoholDayEntry;
import app.alc.model.AlcoholRatioEntry;
...
public class AlcoholStatisticsScreen implements Screen {
    ...
    public AlcoholStatisticsScreen() {
