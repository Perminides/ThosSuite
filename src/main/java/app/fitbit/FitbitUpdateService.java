...
import app.fitbit.FitbitDataFetcher.DayData;
import app.fitbit.json.ActivityLogList;
import app.ui.components.FitbitActivityTableDialog;
...
public class FitbitUpdateService {
    ...
    private final FitbitDataFetcher dataFetcher;
    
    public FitbitUpdateService(FitbitDataFetcher dataFetcher) {
    ...
    private DayImportResult showDialogAndSave(DayData dayData, Window parentWindow) {
        ...
        Optional<FitbitActivityTableDialog.DialogResult> resultOpt = dialog.showAndWait();
        ...
        FitbitActivityTableDialog.DialogResult dialogResult = resultOpt.get();
